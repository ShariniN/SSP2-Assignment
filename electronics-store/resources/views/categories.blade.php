...
@section('title', 'Electronics Categories')
...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
        <div class="container mx-auto px-4 text-center">
            ...
            <!-- Search Bar -->
            <form action="{{ route('categories.search') }}" method="GET" class="max-w-2xl mx-auto">
                ...
                <div class="text-center">
                    <div class="mx-auto w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mb-4">
                        <svg class="w-8 h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192L5.636 18.364M12 2.944a11.955 11.955 0 018.618 3.04A12.02 12.02 0 0021 9c0 5.591-3.824 10.29-9 11.622C6.824 19.29 3 14.591 3 9a12.02 12.02 0 01.382-2.016A11.955 11.955 0 0112 2.944z"></path>
                        </svg>
                    </div>
